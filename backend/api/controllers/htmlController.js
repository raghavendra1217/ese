    ...
    try {
        ...
        if (!disbursementSchedule) {
            ...
            try {
                ...
                } else if (investor.select_plan === '1 lakh' || investor.select_plan === '1lakh') {
                    investmentAmount = 100000;
                } else if (investor.select_plan === '5 lakh' || investor.select_plan === '5lakh') {
                    investmentAmount = 500000;
                } else if (investor.select_plan === '10 lakh' || investor.select_plan === '10lakh') {
                    investmentAmount = 1000000;
                } else {
                    investmentAmount = 100000; // Default fallback
                    console.log(`⚠️ Unknown select_plan for schedule creation: "${investor.select_plan}", using default 1 lakh`);
                }
                console.log(`💰 Investment amount calculated: ${investmentAmount}`);
                
                // Validate plan type and investment date
                const planType = investor.plan_type || '60 days';
                const investmentDate = investor.investment_date || new Date();
                
                console.log(`🔍 Schedule creation validation:`, {
                ...
                // If it's an invalid plan combination error, log it but continue with fallback
                if (error.message.includes('Invalid plan combination')) {
                    console.log(`⚠️ Invalid plan combination detected: ${investor.select_plan} with ${investor.plan_type}`);
                    console.log(`📋 Continuing with fallback data for investor ${id}`);
                }
        ...
        console.log(`💰 Investment amount calculation:`, {
            ...
            is_1lakh_plan: investor.select_plan === '1 lakh' || investor.select_plan === '1lakh',
            is_10lakh_plan: investor.select_plan === '10 lakh' || investor.select_plan === '10lakh',
        ...
        if (disbursementSchedule && disbursementSchedule.disbursements && disbursementSchedule.disbursements.length > 0) {
            ...
            disbursementSchedule.disbursements.forEach((disbursement, index) => {
                ...
                if ((investorData.select_plan === '10k' && investorData.plan_type === '90 days' && index === 3) ||
                    ...
                    ((investorData.select_plan === '5 lakh' || investorData.select_plan === '5 lakh_alt') && investorData.plan_type === '360 days' && index === 12) ||
                ...
                if ((investorData.select_plan === '10k' && investorData.plan_type === '90 days') ||
                    ...
                    ((investorData.select_plan === '5 lakh' || investorData.select_plan === '5 lakh_alt') && investorData.plan_type === '360 days') ||
            ...
            if ((investor.select_plan === '10k' && investor.plan_type === '90 days') ||
                ...
                ((investor.select_plan === '5 lakh' || investor.select_plan === '5 lakh_alt') && investor.plan_type === '360 days') ||
                ...
                if (investor.select_plan === '10k' && investor.plan_type === '90 days') {
                    ...
                    numDisbursements = 16;
                } else if ((investor.select_plan === '5 lakh' || investor.select_plan === '5 lakh_alt') && investor.plan_type === '360 days') {
                    sampleAmount = 50000; // 50k per disbursement for 5L/360d plan (30-day interval)
                    numDisbursements = 12;
                    ...
                    sampleAmount = investmentAmount * 0.15; // 15% of investment as sample disbursement
                    numDisbursements = 4; // Default to 4 disbursements
                }
        ...
        <div class="container">
            ...
            <div class="notes-section">
                ...
                <ul>
                    ...
                    <li>6. The principal amount of ₹10,00,000 will be released within one working day of the user's request, provided that at least 180 days have elapsed.</li>
                    ` : ''}
                    ${investorData.select_plan === '10 lakh' && investorData.plan_type === '360 days' ? `
                    <li>5. The principal amount of ₹10,00,000 will be disbursed only upon the user's request, and only after all previously scheduled disbursements have been completed.</li>
