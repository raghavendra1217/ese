...
// } from '@chakra-ui/react';
// import { SearchIcon } from '@chakra-ui/icons';
// // --- MODIFIED: Imported FaUserPlus and removed unused FaChartBar ---
// import { FaRegUserCircle, FaWallet, FaUserPlus } from 'react-icons/fa'; 
// import { IoMdNotificationsOutline } from 'react-icons/io';
// import { HiOutlineMail } from 'react-icons/hi';
// import { Link as RouterLink } from 'react-router-dom';
// // --- 2. UPDATE: Import useAuth to get user info and logout function ---
...
//         // --- 5. UPDATE: Wrap the return in a React Fragment <> ... </> ---
//         <>
//             {/* --- MODIFIED: Set width to 80% on large screens and centered with mx="auto" --- */}
//             <Flex 
...
//                 {/* --- MODIFIED: Increased icon and text size --- */}
//                 <Flex align="center" gap={3}>
//                     <FaRegUserCircle size={32} />
//                     <Text fontWeight="semibold" fontSize="lg" display={{ base: 'block' }}>
//                         Hello, admin
//                     </Text>
//                 </Flex>
...
import React from 'react';
import {
    Box, Flex, IconButton, Text, useColorModeValue, Tooltip,
    Button, useDisclosure, Modal, ModalOverlay, ModalContent, ModalHeader, 
    ModalFooter, ModalBody, ModalCloseButton, VStack, HStack, useClipboard
} from '@chakra-ui/react';
...
<Flex align="center" gap={3}>
    ...
    <Text 
        fontWeight="semibold" 
        fontSize="lg" // Increased from md to lg
...
<Flex align="center" gap={4}>
    <Tooltip label="Add Member" hasArrow>
        <IconButton 
            ...
            onClick={onOpen}
            aria-label="Add Member"
            fontSize={{ base: '24px', lg: '26px' }} // Increased by 30%
            icon={<FaUserPlus />}
        />
    </Tooltip>
